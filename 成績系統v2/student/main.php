  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light shadow-sm">
      <div class="container-fluid">
        ...
        <span class="ms-2">
          <!-- 哈囉！XX同學 -->
          哈囉！<?php echo htmlspecialchars($studentName); ?> 
        </span>
      ...
      <div class="row row-cols-1 row-cols-md-2 g-4">
        ...
        <div class="col">
          <a href="course.html" class="text-decoration-none">
            <div class="card h-100 shadow-sm text-center">
              <div class="card-body d-flex align-items-center justify-content-center">
                <h4 class="card-title mb-0">課程查詢與選課</h4>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col">
          <a href="score.html" class="text-decoration-none">
            <div class="card h-100 shadow-sm text-center">
              <div class="card-body d-flex align-items-center justify-content-center">
                <h4 class="card-title mb-0">成績查詢</h4>
              </div>
            </div>
          </a>
        </div>
        ...
        <div class="col">
          <a href="record.html" class="text-decoration-none">
            <div class="card h-100 shadow-sm text-center">
              <div class="card-body d-flex align-items-center justify-content-center">
                <h4 class="card-title mb-0">獎懲記錄</h4>
              </div>
            </div>
          </a>
        </div>
